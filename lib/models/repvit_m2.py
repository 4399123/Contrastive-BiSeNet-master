...
class RepVit_M2(nn.Module):
    def __init__(self):
        super(RepVit_M2, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('repvit_m2_3.dist_450e_in1k', features_only=True, out_indices=self.out_indices,pretrained=True)

        # load_checkpoint(self.selected_feature_extractor, '../lib/premodels/repvit_m2.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/repvit_m2.pth')
