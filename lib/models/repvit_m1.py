...
class RepVit_M1(nn.Module):
    def __init__(self):
        super(RepVit_M1, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('repvit_m1_5.dist_450e_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/repvit_m1.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/repvit_m1.pth')
