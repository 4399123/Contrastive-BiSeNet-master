...
class ResNet34(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('resnet34d.ra2_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/resnet34.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/efficientvit_b1.pth')
