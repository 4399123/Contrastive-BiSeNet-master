...
from .mobilenetv4_medium import MobileNetV4_Medium
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = MobileNetV4_Medium()
...
class BiSeNetV1_MobileNetV4_Medium(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_MobileNetV4_Medium, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_MobileNetV4_Medium(19)
    net.eval()
