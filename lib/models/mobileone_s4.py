...
class MobileOne_S4(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('mobileone_s4', features_only=True, out_indices=self.out_indices,pretrained=True)

        # load_checkpoint(self.selected_feature_extractor, '../lib/premodels/mobileone_s4.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/mobileone_s4.pth')
