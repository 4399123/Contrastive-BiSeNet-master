...
class FastVit_SA24(nn.Module):
    def __init__(self):
        super(FastVit_SA24, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('fastvit_sa24', features_only=True, out_indices=self.out_indices,pretrained=True)

        # load_checkpoint(self.selected_feature_extractor, '../lib/models/fastvit_sa24.pth')
        # load_checkpoint(self.selected_feature_extractor, './fastvit_sa24.pth')
