...
from .hgnetv2_b5_topformer import HGNetV2_B5
import numpy as np
...
class TopFormer_HGNetV2_B5(nn.Module):
    def __init__(self, n_classes=5, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(TopFormer_HGNetV2_B5,self).__init__()
