...
from .next_vit_small import Next_Vit_Small
...
class BiSeNetV1_Next_Vit_Small(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_Next_Vit_Small, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_Next_Vit_Small(19)
    net.eval()
