...
class FastVit_T12(nn.Module):
    def __init__(self):
        super(FastVit_T12, self).__init__()
        self.out_indices = [2,3]
        self.selected_feature_extractor = timm.create_model('fastvit_t12.apple_dist_in1k', features_only=True, out_indices=self.out_indices,pretrained=True)
