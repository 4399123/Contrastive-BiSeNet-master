...
class Caformer_S36(nn.Module):
    def __init__(self):
        super(Caformer_S36, self).__init__()
        self.out_indices = [1,2,3]
        self.selected_feature_extractor = timm.create_model('caformer_s36.sail_in22k_ft_in1k_384', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/caformer_s36.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/caformer_s36.pth')
