...
from .repvit_m1 import RepVit_M1
...
class BiSeNetV1_RepVit_M1(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_RepVit_M1, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
