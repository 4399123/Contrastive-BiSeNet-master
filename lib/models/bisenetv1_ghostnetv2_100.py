...
from .ghostnetv2_100 import GhostNetV2_100
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = GhostNetV2_100()
        self.arm16 = AttentionRefinementModule(80, 256)
        self.arm32 = AttentionRefinementModule(160, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(160, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_GhostNetV2_100(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_GhostNetV2_100, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_GhostNetV2_100(19)
    net.eval()
