...
class EfficientNet_Lite0(nn.Module):
    def __init__(self):
        super(EfficientNet_Lite0, self).__init__()
        self.out_indices = [2, 3,4]
        self.selected_feature_extractor = timm.create_model('efficientnet_lite0.ra_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/efficientnet_lite0.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/efficientnet_lite0.pth')
