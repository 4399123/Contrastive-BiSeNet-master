...
class SemNasNet_100(nn.Module):
    def __init__(self):
        super(SemNasNet_100, self).__init__()
        self.out_indices = [ 2,3,4]
        self.selected_feature_extractor = timm.create_model('semnasnet_100.rmsp_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        # load_checkpoint(self.selected_feature_extractor, '../lib/premodels/semnasnet_100.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/semnasnet_100.pth')
