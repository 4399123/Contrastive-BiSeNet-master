...
from .mobileone_s4 import MobileOne_S4
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = MobileOne_S4()
        self.arm16 = AttentionRefinementModule(896, 256)
...
class BiSeNetV1_MobileOne_S4(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_MobileOne_S4, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
