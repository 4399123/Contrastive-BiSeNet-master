...
class FastVit_SA12(nn.Module):
    def __init__(self):
        super(FastVit_SA12, self).__init__()
        self.out_indices = [2,3]
        self.selected_feature_extractor = timm.create_model('fastvit_sa12.apple_dist_in1k', features_only=True, out_indices=self.out_indices,pretrained=True)

        # load_checkpoint(self.selected_feature_extractor, '../lib/models/fastvit_sa12.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/fastvit_sa12.pth')
