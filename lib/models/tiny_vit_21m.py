...
class Tiny_Vit_21m(nn.Module):
    def __init__(self):
        super(Tiny_Vit_21m, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('tiny_vit_21m_224.dist_in22k_ft_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/tiny_vit_21m.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/tiny_vit_21m.pth')
