...
class CSPDarkNet(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('cs3sedarknet_l.c2ns_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/cspdarknet.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/cspdarknet.pth')
