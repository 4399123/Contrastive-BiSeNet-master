...
class Next_Vit_Small(nn.Module):
    def __init__(self):
        super(Next_Vit_Small, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('nextvit_small.bd_ssld_6m_in1k_384', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/nextvit_small.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/nextvit_small.pth')
