...
class HGNetV2_B5(nn.Module):
    def __init__(self):
        super(HGNetV2_B5, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('hgnetv2_b5.ssld_stage2_ft_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/hgnetv2_b5.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/hgnetv2_b5.pth')
