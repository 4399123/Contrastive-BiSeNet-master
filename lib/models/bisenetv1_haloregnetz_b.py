...
from .haloregnetz_b import HaloRegNetZ_B
...
class BiSeNetV1_HaloRegNetZ_B(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_HaloRegNetZ_B, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_HaloRegNetZ_B(19)
    net.eval()
    in_ten = torch.randn(2, 3,512, 512)
