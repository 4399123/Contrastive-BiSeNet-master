...
from .regnety_040 import RegNetY_040
...
class BiSeNetV1_RegNetY_040(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_RegNetY_040, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
