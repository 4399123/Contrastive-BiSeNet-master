...
from .caformer_s36 import Caformer_S36
...
class BiSeNetV1_Caformer_S36(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_Caformer_S36, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
