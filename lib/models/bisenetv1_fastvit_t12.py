...
from .fastvit_t12 import FastVit_T12
...
class BiSeNetV1_FastVit_T12(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_FastVit_T12, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
