...
from .fastvit_sa24 import FastVit_SA24
...
class BiSeNetV1_FastVit_SA24(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_FastVit_SA24, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
