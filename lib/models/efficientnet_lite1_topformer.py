...
class EfficientNet_Lite1(nn.Module):
    def __init__(self):
        super(EfficientNet_Lite1, self).__init__()
        self.out_indices = [1,2, 3,4]
        self.selected_feature_extractor = timm.create_model('tf_efficientnet_lite1.in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/efficientnet_lite1.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/efficientnet_lite1.pth')
