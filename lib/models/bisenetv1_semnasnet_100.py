...
from .semnasnet_100 import SemNasNet_100
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = SemNasNet_100()
        self.arm16 = AttentionRefinementModule(112, 256)
...
class BiSeNetV1_SemNasNet_100(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_SemNasNet_100, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_SemNasNet_100(19)
    net.eval()
