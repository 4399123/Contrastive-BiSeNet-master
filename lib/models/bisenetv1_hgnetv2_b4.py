...
from .hgnetv2_b4 import HGNetV2_B4
...
class BiSeNetV1_HGNetV2_B4(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_HGNetV2_B4, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
