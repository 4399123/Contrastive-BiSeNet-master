...
class MobileNetV4_Medium(nn.Module):
    def __init__(self):
        super(MobileNetV4_Medium, self).__init__()
        self.out_indices = [ 2,3,4]
        self.selected_feature_extractor = timm.create_model('mobilenetv4_hybrid_medium.e500_r224_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        # load_checkpoint(self.selected_feature_extractor, '../lib/premodels/mobilenetv4_medium.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/mobilenetv4_medium.pth')
