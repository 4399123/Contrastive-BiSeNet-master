...
class RegNetY_040(nn.Module):
    def __init__(self):
        super(RegNetY_040, self).__init__()
        self.out_indices = [ 2,3,4]
        self.selected_feature_extractor = timm.create_model('regnety_040.ra3_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/regnety.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/regnety.pth')
