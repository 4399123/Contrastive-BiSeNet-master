...
class HaloRegNetZ_B(nn.Module):
    def __init__(self):
        super(HaloRegNetZ_B, self).__init__()
        self.out_indices = [ 2,3,4]
        self.selected_feature_extractor = timm.create_model('haloregnetz_b.ra3_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        # load_checkpoint(self.selected_feature_extractor, '../lib/premodels/haloregnetz_b.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/haloregnetz_b.pth')
