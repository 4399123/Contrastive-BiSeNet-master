...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            print("Load backbone weights-->segformer_b0_backbone_weights.pth")
            try:
                self.load_state_dict(torch.load("../lib/premodels/segformer_b0_backbone_weights.pth"), strict=False)
            except:
                self.load_state_dict(torch.load("../premodels/segformer_b0_backbone_weights.pth"), strict=False)
...
class mit_b1(MixVisionTransformer):
    def __init__(self, pretrained=False):
        super(mit_b1, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone weights-->segformer_b1_backbone_weights.pth")
            try:
                self.load_state_dict(torch.load("../lib/premodels/segformer_b1_backbone_weights.pth"), strict=False)
            except:
                self.load_state_dict(torch.load("../premodels/segformer_b1_backbone_weights.pth"), strict=False)
#
...
class mit_b2(MixVisionTransformer):
    def __init__(self, pretrained=False):
        super(mit_b2, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone weights-->segformer_b2_backbone_weights.pth")
            self.load_state_dict(torch.load("../lib/premodels/segformer_b2_backbone_weights.pth"), strict=False)
            # self.load_state_dict(torch.load("../premodels/segformer_b2_backbone_weights.pth"), strict=False)
