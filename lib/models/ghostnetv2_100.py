...
class GhostNetV2_100(nn.Module):
    def __init__(self):
        super(GhostNetV2_100, self).__init__()
        self.out_indices = [ 2,3,4]
        self.selected_feature_extractor = timm.create_model('ghostnetv2_100.in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/ghostnetv2_100.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/ghostnetv2_100.pth')
