...
parse.add_argument('--config', dest='config', type=str, default='../configs/bisenetv1_blueface_davit_tiny.py',)
parse.add_argument('--weight-path', type=str, default='../pt/X22/v1_blueface_davit_tiny.pt',)
parse.add_argument('--imgs_path', default=r'D:\blueface\BiSegV2_BlueFace\BlueFaceDataX22\images\train',)
...
for image in tqdm(images):
    ...
    for st in stats[1:]:
        ...
        cv2.imwrite(os.path.join(cutimgpath,'msa_{}_{}.bmp'.format(m,n)), patch_img)
        n+=1
