...
parse.add_argument('--weight-path', type=str, default='../pt/X1/v1_blueface_efficientnet_b3.pt',)
...
# define model
net = model_factory[cfg.model_type](cfg.n_cats, aux_mode='eval',use_fp16=False)
...
for image in tqdm(images):
    ...
    alpha = (1 - mask.astype(np.uint8)) * 240
